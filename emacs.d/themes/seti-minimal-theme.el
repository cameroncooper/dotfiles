...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-preprocessor-face ((,class (:bold ,class :foreground ,keyword))))
   ...
   `(nxml-element-local-name ((,class (:foreground, str))))
...
;;; seti-minimal-theme.el ends here
